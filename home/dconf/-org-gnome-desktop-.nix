...

{
  dconf.settings = {
    ...
    "org/gnome/desktop/notifications" = {
      application-children = [ "org-gnome-console" "code" "firefox" "org-gnome-nautilus" "teams-for-linux" "discord" "dolphin-emu" "slack" "steam" "net-lutris-lutris" "gnome-power-panel" "org-gnome-totem" "idea-ultimate" "lm-studio" ];
      show-banners = true;
    };
    ...
    "org/gnome/desktop/notifications/application/lm-studio" = {
      application-id = "lm-studio.desktop";
    };
